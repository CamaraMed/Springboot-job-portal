...
<title>Search jobs | LooKForJobs.com</title>
	...
	<div class="container-fluid">
		...
		<div class="well">
			<form class="form-inline row well" style="margin: 5px"
				...
				<div class="form-group col-sm-4">
					<label class="col-sm-12" for = "keywords"> Kewords</label>
		...
		<div class="results">
			...
			<c:forEach items="${jobs}" var="job">
				<a class="a1" href="/showjob?userId=${seeker.jobseekerId}&jobId=${job.jobId}">Apply</a>
				<div class="row">
