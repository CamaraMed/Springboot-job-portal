...
<title>Update jobs | LookForJobs.com</title>
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="container-fluid">
				<div class="navbar-header">
					<a class="navbar-brand" href="/findjobs">LookForJobs.com</a>
				</div>
					...
					<form action="/JobPosting/update/${job.jobId}" method="post">
						...
						<div class="col-sm-12">
							<div class="row">
								...
								<div class="col-sm-4 form-group">
									<label>Company</label> <input type="text" readonly
										name="company" value="${company.companyName }"
										class="form-control">
								</div>
							...
							<div class="form-group">
								...
								<textarea rows="3" name="description" class="form-control">${job.description }</textarea>
							</div>
							<div class="row">
							...
							<div class="btn-group btn-group-justified" data-toggle="buttons">
								...
								<input
									type="radio" name="state" value="0" autocomplete="off">
									Open
								</label> 
								<label class="btn btn-default"> <input type="radio"
									name="state" value="1" autocomplete="off"> Filled
								</label> 
								<label class="btn btn-default"> <input type="radio"
									name="state" value="2" autocomplete="off"> Cancelled
								</label>
